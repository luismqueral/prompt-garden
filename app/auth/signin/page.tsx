      ...
      <div className="px-6 py-8 flex-1 mx-auto max-w-md w-full flex flex-col justify-center">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2 px-4 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center justify-center"
          >
            {isLoading ? (
