...
import('../lib/utils/blockUtils.js').then(({ contentToBlocks, blocksToContent }) => {
  import('../lib/utils/migration.js').then(({ migrateToTagFormat, migrateToLegacyFormat }) => {
